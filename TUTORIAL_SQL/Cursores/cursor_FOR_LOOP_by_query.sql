--Cursor FOR LOOP, passing sql query
DECLARE
BEGIN
  FOR vendedor IN (SELECT 
    ...
    LOOP
      DBMS_OUTPUT.PUT_LINE('Vendedor: ' || vendedor.NOMBRE_VENDEDOR ||'. INGRESOS GENERADOS: ' || vendedor.INGRESOS_VENDEDOR || '.');
    END LOOP;
END;